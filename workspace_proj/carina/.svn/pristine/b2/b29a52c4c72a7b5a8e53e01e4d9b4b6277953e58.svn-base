			...
			<section id="shareResult" class="mx-auto my-5 py-5 px-3">
				...
				<div class="card bg-primary shadow-soft border-light mt-5 ">
					<div class="resultname text-center p-5">
						<strong>환경교과서형</strong>
					</div>
					<div id="resultImg"
						class="my-3 col-lg-6 col-md-8 col-sm-10 col-12 mx-auto">
						<img
							src="${pageContext.request.contextPath}/assets/img/mbti/image-0.png"
							alt="0" class="img-fluid">
					</div>
					<div class="resultDesc mt-5 mb-5 text-center">
	
						<p>실제로 행동으로 나타내며, 환경보호에 실질적인 참여를 하는 유형 바로 당신입니다!</p>
						<p>지속할 수 있는 생활에 대한 지식과 행동을 적극적으로 실천하는 사람으로,</p>
						<p>주거 환경에서도 친환경적인 선택을 중시하고 있습니다.</p>
						<p>재생할 수 있는 에너지, 환경친화적인 소재, 재활용에 대한 지식이 당신의 주거 공간을 차지하고 있죠!!</p>
						<p>집안에서 자연과의 조화를 강조하면서도,</p>
						<p>다양한 친환경 비결을 활용하여 지구를 보호하는 데에 기여하고 있습니다.</p>
						<hr />
	
						<span class="highlight1" style="font-size: 2rem"><br /> <br />
							<strong>당신의 주거 환경은 마치 환경 교과서를 따라가듯,<br />지구 친화적인 삶을 보여주고
								있네요!!
						</strong> </span>
