        ...
        <section class="section section-lg">
            <div class="container">
			    ...
			    <c:if test="${sessionScope.login.memId == freeboard.memId}">
			        ...
			        <c:if test="${sessionScope.login.memId == freeboard.memId || sessionScope.login.memId == 'admin' }">
			            <form action="<c:url value="/actboardDel"/>" method ="post">
			                <input type="hidden" name="boardNo" value="${actboard.boardNo}">
			                <button type="submit" class="btn btn-danger btn-sm ml-1"><span class=ml-1">삭제</span>
			                </button>
			            </form>
			        </c:if>
