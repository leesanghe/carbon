	...
	<script>
		...
		$('#savePdf').click(function() {
		  html2canvas(document.body).then(function(canvas) {
		    ...
		    var pageHeight = imgWidth * 1.414; // A4 기준 세로 길이 계산
				...
				<div class="card bg-primary shadow-inset border-light w-100">
					<div class="card-body p-5 ">
						...
						<div
							...
							style="width: 800px; height: 800px; display: flex; justify-content: center; align-items: center;"
							>
							<canvas id="myDoughnutChart" style="width: 700px; height: 700px"></canvas>
						</div>
